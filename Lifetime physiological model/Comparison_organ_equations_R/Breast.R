...
Model_1 <- (3.42e-04*(1/(1+exp(-1.42*Body[["M"]][["age_y"]]+20.1))))*Body[["M"]][["BW"]]

### Verver et al. (2008) - spaceholder
Model_11 <- "NA"

Model_List_M <-cbind.data.frame(Model_1, Model_11)
Body[["M"]]$Breast<- Model_List_M
...
##############################################################
### Beaudouin et al. (2010)
Model_1 <- (0.00833*1/(1+exp(-1.92*Body[["F"]][["age_y"]]+28.6)))*Body[["F"]][["BW"]]

### Verver et al. (2008)
Model_11 <- 0.0062*Body[["F"]][["BW"]]


Model_List_F <-cbind.data.frame(Model_1, Model_11)
Body[["F"]]$Breast<- Model_List_F
...
Body_M <- Body[["M"]]
Body_M[12] <- unlist(Body[["M"]][["Breast"]][["Model_1"]])
Body_M[13] <- unlist(Body[["M"]][["Breast"]][["Model_11"]])
Body_M[["Gender"]]  <- "Male"
...
Body_F <- Body[["F"]]
Body_F[12] <- unlist(Body[["F"]][["Breast"]][["Model_1"]])
Body_F[13] <- unlist(Body[["F"]][["Breast"]][["Model_11"]])
...
LifeTimeChangesOrgans[["M"]]$Breast <- Body[["M"]]$Breast
LifeTimeChangesOrgans[["F"]]$Breast <- Body[["F"]]$Breast
