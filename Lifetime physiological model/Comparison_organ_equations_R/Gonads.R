...
Model_1 <-  ifelse(Body[["M"]][["age_y"]] < 20.1,
                   (-1.516e-07*Body[["M"]][["age_y"]]^3 + 
                      9.3351e-06*Body[["M"]][["age_y"]]^2 -
                      1.1177e-04*Body[["M"]][["age_y"]] +
                      4.7966e-04) * Body[["M"]][["BW"]],
                   0.0008 * Body[["M"]][["BW"]])

### Haddad et al. (2001)
Model_2 <-  ifelse(Body[["M"]][["age_y"]] < 18,
                   (0.0013*Body[["M"]][["age_y"]]**4 - 
                      0.01*Body[["M"]][["age_y"]]**3 - 
                      0.104*Body[["M"]][["age_y"]]**2 + 
                      1.0584*Body[["M"]][["age_y"]] + 1.78)/1000,
                   (0.0013*18**4 - 0.01*18**3 - 0.104*18**2 + 1.0584*18 + 1.78)/1000)
...
Model_8 <-  ifelse(Body[["M"]][["age_y"]] < 18,
                   (8.52e-02*Body[["M"]][["age_h"]]**1 + 8.31e-02*(Body[["M"]][["age_h"]]**(9.99e-01)) + 1.10e+00)/500000,
                   (8.52e-02*(18*365*24)**1 +  8.31e-02*((18*365*24)**(9.99e-01)) + 1.10e+00)/500000)
...
Model_List_M <-cbind.data.frame(Model_1, Model_2, Model_3,  Model_8, Model_11)
Body[["M"]]$Gonads<- Model_List_M
...
Model_1 <- ifelse(Body[["F"]][["age_y"]] <=1,
                  (-1.064e-03*Body[["F"]][["age_y"]]+   1.338e-03)*Body[["F"]][["BW"]],
                  ifelse(Body[["F"]][["age_y"]] < 20,
                         (2.6380e-07*Body[["F"]][["age_y"]]^3 - 
                            1.7943e-06*Body[["F"]][["age_y"]]^2 -
                            5.6465e-06*Body[["F"]][["age_y"]] +
                            2.8105e-04) * Body[["F"]][["BW"]],
                             0.001552 *Body[["F"]][["BW"]]))

### Haddad et al. (2001)
Model_2 <- ifelse(Body[["F"]][["age_y"]] < 18,
                  (0.0044*Body[["F"]][["age_y"]]**3 + 
                     0.0412*Body[["F"]][["age_y"]]**2 +
                     0.2333*Body[["F"]][["age_y"]] + 2.1725)/1000,
                  (0.0044*18**3 + 0.0412*18**2 + 0.2333*18 + 2.1725)/1000)
...
Model_8 <- ifelse(Body[["F"]][["age_y"]] < 18,
                  (8.52e-02*Body[["F"]][["age_h"]]**1 +     8.31e-02*(Body[["F"]][["age_h"]]**(9.99e-01)) + 1.10e+00)/500000,
                  (8.52e-02*(18*365*24)**1 +8.31e-02*((18*365*24)**(9.99e-01)) + 1.10e+00)/500000)
                     
### Verner et al. (2008)
Model_11 <- 0.0014*Body[["F"]][["BW"]]

Model_List_F <-cbind.data.frame(Model_1, Model_2, Model_3,  Model_8, Model_11)
Body[["F"]]$Gonads<- Model_List_F
...
Body_M <- Body[["M"]]
Body_M[12] <- unlist(Body[["M"]][["Gonads"]][["Model_1"]])
Body_M[13] <- unlist(Body[["M"]][["Gonads"]][["Model_2"]])
Body_M[14] <- unlist(Body[["M"]][["Gonads"]][["Model_3"]])
Body_M[15] <- unlist(Body[["M"]][["Gonads"]][["Model_8"]])
Body_M[16] <- unlist(Body[["M"]][["Gonads"]][["Model_11"]])
Body_M[["Gender"]]  <- "Male"
...
Body_F <- Body[["F"]]
Body_F[12] <- unlist(Body[["F"]][["Gonads"]][["Model_1"]])
Body_F[13] <- unlist(Body[["F"]][["Gonads"]][["Model_2"]])
Body_F[14] <- unlist(Body[["F"]][["Gonads"]][["Model_3"]])
Body_F[15] <- unlist(Body[["F"]][["Gonads"]][["Model_8"]])
Body_F[16] <- unlist(Body[["F"]][["Gonads"]][["Model_11"]])
...
LifeTimeChangesOrgans[["M"]]$Gonads <- Body[["M"]]$Gonads
LifeTimeChangesOrgans[["F"]]$Gonads <- Body[["F"]]$Gonads
