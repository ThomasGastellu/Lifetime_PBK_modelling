...
Model_1 <- (0.05+(0.0138-0.05)*exp(-0.112*Body[["M"]][["age_y"]]))*Body[["M"]][["BW"]]

### Haddad et al. (2001)
Model_2 <- ifelse(Body[["M"]][["age_y"]] < 18,
                  (1.9956e-03*Body[["M"]][["age_y"]]**6 - 
                     0.11169*Body[["M"]][["age_y"]]**5 + 
                     2.189*Body[["M"]][["age_y"]]**4 - 
                     17.726*Body[["M"]][["age_y"]]**3 + 
                     59.767*Body[["M"]][["age_y"]]**2 + 
                     14.405*Body[["M"]][["age_y"]] + 73.716)/1000,
                  (1.9956e-03*18**6 - 0.11169*18**5 + 2.189*18**4 - 17.726*18**3 + 59.767*18**2 + 14.405*18 + 73.716)/1000)
...
### Smith et al. (2014)
Model_4 <- (2.100e-02)*Body[["M"]][["BW"]]

Model_List_M <-cbind.data.frame(Model_1, Model_2, Model_3, Model_4)
Body[["M"]]$Marrow<- Model_List_M
##############################################################
# 2b. female-specific physiological equations for models
##############################################################

### Beaudouin et al. (2010)
Model_1 <- (0.045+(0.0138-0.045)*exp(-0.136*Body[["F"]][["age_y"]]))*Body[["F"]][["BW"]]

### Haddad et al. (2001)
Model_2 <-  ifelse(Body[["F"]][["age_y"]] < 18,
                   (7.984e-04*Body[["F"]][["age_y"]]**6 - 
                      0.037966*Body[["F"]][["age_y"]]**5 + 
                      0.5272*Body[["F"]][["age_y"]]**4 - 
                      1.1311*Body[["F"]][["age_y"]]**3 - 
                      12.285*Body[["F"]][["age_y"]]**2 + 
                      123.87*Body[["F"]][["age_y"]]+ 53.358)/1000,
                   (7.984e-04*18**6 - 0.037966*18**5 + 0.5272*18**4 - 1.1311*18**3 - 12.285*18**2 + 123.87*18 + 53.358)/1000)

### Price K. et al. (2003) - spaceholder
Model_3 <- "NA"        

### Smith et al. (2014)
Model_4<- (2.100e-02)*Body[["F"]][["BW"]]

Model_List_F <-cbind.data.frame(Model_1, Model_2, Model_3, Model_4)
Body[["F"]]$Marrow<- Model_List_F
...
Body_M <- Body[["M"]]
Body_M[12] <- unlist(Body[["M"]][["Marrow"]][["Model_1"]])
Body_M[13] <- unlist(Body[["M"]][["Marrow"]][["Model_2"]])
Body_M[14] <- unlist(Body[["M"]][["Marrow"]][["Model_3"]])
Body_M[15] <- unlist(Body[["M"]][["Marrow"]][["Model_4"]])
Body_M[["Gender"]]  <- "Male"
...
Body_F <- Body[["F"]]
Body_F[12] <- unlist(Body[["F"]][["Marrow"]][["Model_1"]])
Body_F[13] <- unlist(Body[["F"]][["Marrow"]][["Model_2"]])
Body_F[14] <- unlist(Body[["F"]][["Marrow"]][["Model_3"]])
Body_F[15] <- unlist(Body[["F"]][["Marrow"]][["Model_4"]])
...
LifeTimeChangesOrgans[["M"]]$Marrow <- Body[["M"]]$Marrow
LifeTimeChangesOrgans[["F"]]$Marrow <- Body[["F"]]$Marrow
